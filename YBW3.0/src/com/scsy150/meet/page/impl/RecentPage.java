...
public class RecentPage extends BasePage {
	...
	public RecentPage(Activity activity) {
		super(activity);
		initData();
		messageLoop();
	}
	...
	public RecentPage(Activity activity, int[] mImageIds) {
		super(activity);
	...
	public void initData() {
		...
		RequestAndLoadCookies stringRequest = new RequestAndLoadCookies(
					...
					public void onResponse(String str) {
						...
						if (item.getIsSuccess() == SystemConsts.RESPONSE_SUCCESS) {
							...
							try {
								...
								ArrayList<MeetInfoBean> list = gson.fromJson(
			...
			protected Map<String, String> getParams() throws AuthFailureError {
				...
				map.put("ACIVITYTYPE", SystemConsts.ACTIVITY_TYPE_RECENT + "");
				map.put("LONGITUDE", 1 + "");
				map.put("LATITUDE", 1 + "");
