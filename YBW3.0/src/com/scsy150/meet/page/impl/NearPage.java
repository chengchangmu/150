...
public class NearPage extends BasePage {
	...
	public NearPage(Activity activity) {
		super(activity);
		initData();
		messageLoop();
	}
	...
	private ArrayList<MeetInfoBean> mList;
	...
	// 活动筛选: 默认全部
	private int merchantType = SystemConsts.MERCHANT_TYPE_ALL;
	// 时间日期: 默认全部
	...
	public NearPage(Activity activity, int[] mImageIds) {
		super(activity);
	...
	public View initView() {
		...
		// 假数据
		/*
		 * ArrayList<String> list = new ArrayList<String>(); list.add("1Near");
		 * list.add("2Near"); list.add("3Near"); list.add("4Near");
		 * list.add("5Near"); list.add("6Near"); mLvContainer.setAdapter(new
	...
	public void findView_addListener() {
		...
		mLvContainer.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				intent.putExtra("activity_id", mMeetInfoList.get(position - 2)
						.getAcId());
	...
	public void initData() {
		...
		RequestAndLoadCookies stringRequest = new RequestAndLoadCookies(
			...
			protected Map<String, String> getParams() throws AuthFailureError {
				...
				map.put("ACIVITYTYPE", SystemConsts.ACTIVITY_TYPE_NEAR + "");
				map.put("LONGITUDE", 1 + "");
				map.put("LATITUDE", 1 + "");
