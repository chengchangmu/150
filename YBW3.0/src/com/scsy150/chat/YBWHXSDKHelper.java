...
import com.scsy150.chat.applib.controller.HXSDKHelper;
import com.scsy150.chat.applib.model.HXSDKModel;
import com.scsy150.chat.domain.User;
import com.scsy150.chat.receiver.CallReceiver;
...
public class YBWHXSDKHelper extends HXSDKHelper{
    ...
    protected HXSDKModel createModel() {
        return new YBWHXSDKModel(appContext);
    }
    
    /**
     * get demo HX SDK Model
     */
    public YBWHXSDKModel getModel(){
        return (YBWHXSDKModel) hxModel;
    }
    ...
    public Map<String, User> getContactList() {
        if (getHXId() != null && contactList == null) {
            contactList = ((YBWHXSDKModel) getModel()).getContactList();
        }
