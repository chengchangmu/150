 ...
 * 图片圆角描边说明
 * 
 * 调用说明： 在布局直接引用： <com.scsy150.widget.RoundedImageView
 ...
 * initData()方法中
 * 
 * com.scsy150.util.view.RoundedImageView
 * 
 * @author ChengChangmu <br/>
 *         Create at 2015-08-30 下午4:28:26
 */
public class RoundedImageView extends ImageView {
	...
	private int mBorderColor = R.color.common_press_color;
	...
	private void initData() {
		//设置图片源
		setBackgroundResource(R.drawable.image_btn_gray_close_icon);
		// 描边颜色
