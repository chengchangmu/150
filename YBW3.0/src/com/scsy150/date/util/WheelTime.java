...
public class WheelTime {
	...
	public static void setStartHours(int startHours) {
	 ...
	 * @param view
	 */
	public static DateFormat getNowTime() {
		return dateFormat;
	}

	public static void setNowTime(DateFormat nowDayFormat) {
		dateFormat = nowDayFormat;
