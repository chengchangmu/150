...
public class TimePopupWindow extends PopupWindow implements OnClickListener {
	 ...
	 * @param END_YEAR
	 */
	public void setRange(int START_YEAR, int START_MOUTH, int START_DAY,
			int START_HOUR, int START_MINUTE) {
		WheelTime.setSTART_YEAR(START_YEAR);
		WheelTime.setStartMonth(START_MOUTH);
		WheelTime.setStartDay(START_DAY);
		WheelTime.setStartHours(START_HOUR);
		WheelTime.setStartMinute(START_MINUTE);
	...
	public void setNowTime(DateFormat dateFormat) {
		WheelTime.setNowTime(dateFormat);
	}
