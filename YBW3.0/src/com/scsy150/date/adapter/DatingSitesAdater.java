...
public abstract class DatingSitesAdater<T> extends BaseAdapter {
	Context mContext;
	List<T> mList;
	LayoutInflater inflater;

	public DatingSitesAdater(Context context, List<T> list) {
	...
	public View getView(int postion, View converView, ViewGroup parent) {
		ViewHolder holder = ViewHolder.get(mContext, converView, parent,
				R.layout.item_dating_sites_layout, postion);
